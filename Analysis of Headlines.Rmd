...
description: |
  Text as Data Project Headline Comparison Research
preview: Analysis-of-Headlines_files/figure-html5/unnamed-chunk-12-1.png
categories:
  - text as data
...
```{r code_folding = TRUE}
#load data
main_headlines <- read.csv("./data/afghanistan_withdrawal_main.csv")
main_headlines <- as.data.frame(main_headlines)
#turn into data frame
print_headlines <- read.csv("./data/afghanistan_withdrawal_print.csv")
